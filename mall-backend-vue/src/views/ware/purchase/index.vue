  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="${comment}" prop="assigneeId">
          <el-input v-model="form.assigneeId" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="assigneeName">
          <el-input
        ...
        <el-form-item label="${comment}" prop="priority">
          <el-input v-model="form.priority" placeholder="请输入${comment}" />
        </el-form-item>
        ...
        <el-form-item label="${comment}" prop="wareId">
          <el-input v-model="form.wareId" placeholder="请输入${comment}" />
        </el-form-item>
