  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
       <el-form-item label="仓库">
        <el-select size="mini" style="width:160px;" v-model="queryParams.wareId" placeholder="请选择仓库" clearable>
...
<script>
import { listSku, getSku, delSku, addSku, updateSku } from "@/api/ware/sku";
