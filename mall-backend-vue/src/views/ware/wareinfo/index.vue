...
<script>
import { listInfo, getInfo, delInfo, addInfo, updateInfo } from "@/api/ware/info";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ware/info/export', {
        ...this.queryParams
      }, `ware_info.xlsx`)
    }
  }
