<template>
  <div>
    <el-select placeholder="请选择" size="small" v-model="brandId" filterable clearable>
      <el-option
...
import {listBrandRelation} from '@/api/product/relation'
export default {
  ...
  methods: {
    getCatBrands() {
      listBrandRelation({catId:this.catId}).then((res)=>{
